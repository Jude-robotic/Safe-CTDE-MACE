...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train the shared DQN Safe-CTDE-MACE baseline.")
    parser.add_argument("--config", type=str, default=None, help="Path to a YAML config file.")
    parser.add_argument("--episodes", type=int, default=None, help="Override number of training episodes.")
    parser.add_argument("--output", type=str, default="checkpoints/shared_dqn_final.pt", help="Final model path.")
    parser.add_argument("--eval-episodes", type=int, default=3, help="Greedy evaluation episodes after training.")
    parser.add_argument("--artifact-dir", type=str, default="artifacts/train", help="Directory for reports and plots.")
